...
*   Đây chính là bản chất cốt lõi của "Iterative Prompting": Ta không kỳ vọng AI làm đúng hoàn hảo ở lần đầu, mà coi AI như một người cộng sự để ta liên tục cấp feedback (phản hồi) và định hướng để tinh chỉnh dần tới kết quả cuối cùng tối ưu nhất.
...
*   **Phương án B (Mở phiên chat mới và lặp lại prompt cũ đổi sang in hoa):** 
    ...
    *   Lặp lại một prompt thô cũ chỉ bằng cách viết hoa toàn bộ chữ không giải quyết được nguyên nhân gốc rễ. Máy móc (AI) không "hiểu" cảm xúc hay sự bực tức của người dùng. Theo nguyên lý "Garbage in, Garbage out", nếu prompt không chứa thông tin điều chỉnh thuật toán (căn bậc hai), AI vẫn sẽ sinh ra kết quả tương tự hoặc lan man không đúng trọng tâm.
